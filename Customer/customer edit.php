...
<div class="right">
        ...
        <p><label>Date of Birth:</label><input  type="date" name="user_dob" value="<?php echo $_SESSION['user_dob'];?>" id="user_dob">
        
        <p><label>Phone Number:</label><input  type="text" name="user_phone_number" size="40" placeholder="Please enter your phone number" id="user_phone_number" value="<?php echo $_SESSION['user_phone_number'];?>">

        <p><label>Email:</label><input  type="text" name="user_email" size="40" placeholder="Please enter your email" id="user_email" value="<?php echo $_SESSION['user_email'];?>">

        <p><label>Address:</label><textarea  cols="40" rows="3" name="user_address" id="user_address"> <?php echo $_SESSION['user_address'];?></textarea>
        <input type="hidden" name="user_password" value="<?php echo $_SESSION['user_password'];?>">
